 ...
 */
Image convertToGrayscale(const Image& input) { //menna
 ...
 */
Image flipHorizontal(const Image& input) { //lasheen
    int height = input.getHeight();
    int width = input.getWidth();
 ...
 * 3. Return the flipped image
 */
Image flipVertical(const Image& input) { //menna
    int height = input.getHeight();
    int width = input.getWidth();
    int channels = input.getChannels();
    Image output(width, height, channels);
 ...
 */
Image adjustBrightness(const Image& input, int value) { //haz
    int height = input.getHeight();
    int width = input.getWidth();
    int channels = input.getChannels();
    Image output(width, height, channels);
 ...
 * 3. Return the adjusted image
 */
Image adjustContrast(const Image& input, float factor) { //hazem
    int height = input.getHeight();
    int width = input.getWidth();
    int channels = input.getChannels();
    Image output(width, height, channels);
 ...
 */
Image applyBlur(const Image& input) { //lasheen
    int height = input.getHeight();
    int width = input.getWidth();
    int channels = input.getChannels();
    Image output(width, height, channels);
 ...
 */
Image rotate90(const Image& input) { //hazem
    int height = input.getHeight();
    int width = input.getWidth();
    int channels = input.getChannels();
